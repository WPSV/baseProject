...
export default function Select({
  ...
  const defaultClassNames = {
    base: ["mb-5"],
    label: ["pb-[6px]"],
    mainWrapper: ["bg-light-100 dark:bg-secondary-200 border border-solid border-outline rounded h-[56px]"],
    trigger: ["dark:bg-secondary-200 rounded-[3px] h-14"],
    innerWrapper: [],
    selectorIcon: [],
    value: [],
    listboxWrapper: [],
    listbox: [],
    popoverContent: ["bg-secondary-200 text-light-100 rounded"],
    helperWrapper: [],
    description: [],
    errorMessage: [],
  };
